      ...
      dailyLog.forEach((log, i) => {
        ...
        if (
          ...
          if (log.hasTimeZoneDifference) {
            log.intervalStartThere = moment
              .tz(intervalStart, log.timeZoneThereName)
              .format("h:mm a z");
            log.intervalStartHere = moment
              .tz(intervalStart, log.timeZoneHereName)
              .format("h:mm a z");
          } else {
            log.intervalStart = moment
              .tz(intervalStart, log.timeZoneName)
              .format("h:mm a");
          }
